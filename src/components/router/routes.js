...
import AllUserLocation from "../ModalComponents/AllUserLocation";
import SimpleMap from "../ModalComponents/UserLocations";
      ...
      <Routes>
        ...
        <Route element={<ProtectedRoutes />}>
          <Route path="/" element={<AllNavigationBar />}>
            ...
            <Route path="/user-location" element={<AllUserLocation />}/>
          </Route>
        </Route>
      </Routes>
    </div>
